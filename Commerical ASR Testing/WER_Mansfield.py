...
result_df = pd.read_excel(result_path, sheet_name="Mansfield_output_wav2vec")
...
x = 0
with open('speech/Measurement Results/Mansfield_measures_wav2vec.csv', 'w', newline= '') as out_file:
