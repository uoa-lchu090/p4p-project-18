...
result_df = pd.read_excel(result_path, sheet_name="Mansfield_output_google_US")
...
x = 0
with open('speech/Measurement Results/Mansfield_measures_google_US.csv', 'w', newline= '') as out_file:
